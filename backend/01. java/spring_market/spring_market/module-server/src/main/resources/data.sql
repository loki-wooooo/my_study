...
SELECT
    ...
    'SYSTEM_USER',
    'SYSTEM_USER'
FROM tb_category WHERE CATEGORY_NAME = '패션의류';
...
SELECT
    ...
    'SYSTEM_USER',
    'SYSTEM_USER'
FROM tb_category WHERE CATEGORY_NAME = '가전제품';
...
SELECT
    ...
    'SYSTEM_USER',
    'SYSTEM_USER'
FROM tb_category WHERE CATEGORY_NAME = '남성의류';
...
SELECT
    ...
    'SYSTEM_USER',
    'SYSTEM_USER'
FROM tb_category WHERE CATEGORY_NAME = '여성의류';
...
SELECT
    ...
    'SYSTEM_USER',
    'SYSTEM_USER'
FROM tb_category WHERE CATEGORY_NAME = '주방가전';
...
BEGIN
    FOR i IN 1..100000 LOOP
        ...
        VALUES (
            product_id,
            (SELECT CATEGORY_ID FROM tb_category WHERE CATEGORY_LEVEL = 3 ORDER BY RANDOM() LIMIT 1),
            '상품_' || i,
            '상품 설명 ' || i,
        ...
        CASE (i % 4)
            ...
            WHEN 1 THEN
                FOR j IN 1..2 LOOP
                    add_prod_id := uuid_generate_v4();
                    INSERT INTO tb_additional_product (
            ...
            WHEN 2 THEN
                FOR opt_group_name IN (
                    ...
                    opt_group_id := uuid_generate_v4();
                    INSERT INTO tb_product_option_group (
