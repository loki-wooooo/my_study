...
public class CommonEntity implements Serializable {
    ...
    @CreatedBy
    @Column(name = "CREATED_USER_ID", length = 200, nullable = true, updatable = false)
    @Comment("생성자 ID")
    @Builder.Default
    String createdUserId = "SYSTEM_USER";
    ...
    @LastModifiedBy
    @Column(name = "LAST_EDITED_USER_ID", length = 200, nullable = true)
    @Comment("수정자 ID")
    @Builder.Default
    String lastEditedUserId = "SYSTEM_USER";
