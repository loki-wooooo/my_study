...
//        // 명시적으로 ack 추가(auto -> default 모드)
//        // 자동 Acknowledge: AcknowledgeMode.AUTO 설정에 따라, 메시지 처리가 완료되면 Spring AMQP가 자동으로 RabbitMQ 서버에 Acknowledge를 보냅
...
//     * */
//    @Bean
//    public MessageListenerAdapter listenerAdapter(final WorkQueueConsumer receiver) {
